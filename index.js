...
function addFlavor(array,flavor){
   console.log(array.unshift(flavor))
   return array
}
addFlavor(originalFlavors,'fudge')
...
removeFlavorByName(originalFlavors, 'fudge')
...
Use the filterByWord function below to do the following:
    ...
    For example: filterByWord(originalFlavors, "") should return ["Chocolate", "Chocolate Almond", "Chocolate Chip", "Chocolate Fudge", "Chocolate Mint", "Chocolate Ribbon"]
